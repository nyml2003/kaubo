...
//   override; antlrcpp::Any visitAtom(Python3Parser::AtomContext* ctx)
//   override; antlrcpp::Any visitExpr(Python3Parser::ExprContext* ctx)
//   override;
...
//   antlrcpp::Any visitTestlist_comp(
//     Python3Parser::Testlist_compContext* ctx
//   ) override;

//   antlrcpp::Any visitCompound_stmt(
...
//   antlrcpp::Any visitTypedargslist(
...
//   antlrcpp::Any visitSubscriptlist(
//     Python3Parser::SubscriptlistContext* ctx
//   ) override;

//   antlrcpp::Any visitSubscript_(Python3Parser::Subscript_Context* ctx)
//   override;
...
//   antlrcpp::Any visitPass_stmt(Python3Parser::Pass_stmtContext* ctx)
//   override;

//   antlrcpp::Any visitYield_stmt(Python3Parser::Yield_stmtContext* ctx)
//   override;

//   antlrcpp::Any visitYield_expr(Python3Parser::Yield_exprContext* ctx)
//   override;

//   antlrcpp::Any visitImport_stmt(
