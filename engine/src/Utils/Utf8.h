  ...
  switch (expected_length) {
    ...
    case 2: {
      ...
      codepoint = static_cast<char32_t>(
        ((leading_byte & Const::DATA_MASK_2BYTE) << Const::SHIFT_6) |
    ...
    case 3: {
      ...
      codepoint = static_cast<char32_t>(
        ((leading_byte & Const::DATA_MASK_3BYTE) << Const::SHIFT_12) |
    ...
    case 4: {
      ...
      codepoint = static_cast<char32_t>(
        ((leading_byte & Const::DATA_MASK_4BYTE) << Const::SHIFT_18) |
 ...
 */
inline auto quick_get_utf8_byte_length(uint8_t leading_byte) noexcept
  -> Result<size_t, Error> {
...
namespace std {
inline auto to_string(kaubo::Utils::Utf8::Error error) noexcept -> std::string {
  switch (error) {
    case kaubo::Utils::Utf8::Error::InvalidPosition:
      return "Invalid position";
    case kaubo::Utils::Utf8::Error::IncompleteSequence:
      return "Incomplete sequence";
    case kaubo::Utils::Utf8::Error::OverlongEncoding:
      return "Overlong encoding";
    case kaubo::Utils::Utf8::Error::InvalidCodePoint:
      return "Invalid code point";
    case kaubo::Utils::Utf8::Error::InvalidContinuation:
      return "Invalid continuation";
    case kaubo::Utils::Utf8::Error::InvalidLeadingByte:
...
inline auto to_string(const std::vector<char32_t>& codepoints) noexcept
  -> std::string {
  return kaubo::Utils::Utf8::build_string(codepoints);
}
}  // namespace std